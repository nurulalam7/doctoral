              ...
              <div className='col-span-2 my-20'>
                ...
                <div >
                  <form onSubmit={handleSubmit(onSubmit)} className='flex grid grid-cols-6 my-20 gap-2 ' action="" >
                    <input {...register("name")}  className='col-span-3  rounded py-2 px-4' type="text" name='name'  placeholder='search by name' />
                    <input {...register("location")} className='col-span-2  rounded py-2 px-4' type="text" name='location' placeholder='search by location' />
